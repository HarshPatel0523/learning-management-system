...
//                             <img src={apj} className="w-40 rounded-full border-2 border-gray-400 p-2" />
...
//                          <div className='flex flex-col items-center justify-center gap-4 px-[15%]'>
//                             <img src={steveJobs} className="w-40 rounded-full border-2 border-gray-400 p-3" />
...
//                         <div className='flex flex-col items-center justify-center gap-4 px-[15%]'>
//                             <img src={billGates} className="w-40 rounded-full border-2 border-gray-400 pt-2" />
...
//                         <div className='flex flex-col items-center justify-center gap-4 px-[15%]'>
//                             <img src={nelsonMandela} className="w-40 rounded-full border-2 border-gray-400 p-2" />
